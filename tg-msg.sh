...
(
    ...
    #156***4409 快乐的吖娇
    echo "msg @JD_ShareCode_Bot /farm 87a7f05dbd6a4564903792c1745695bc"
    echo "msg @JD_ShareCode_Bot /pet MTE1MzEzNjI2MDAwMDAwMDU2MzY4OTE5"
    echo "msg @JD_ShareCode_Bot /bean dzfuhp3b2fz7medovlqxspml2k6gxejshui27pq"
    ...
    #173****8741 jd_KyLTiNajSjZk
    echo "msg @JD_ShareCode_Bot /farm eebf469beae04250b1e3fa7b599862cc"
    echo "msg @JD_ShareCode_Bot /pet MTEzMzI1MTE4NDAwMDAwMDA1Mzc2MTI3OQ=="
    echo "msg @JD_ShareCode_Bot /bean gcdr655xfdjq6g4xh3ddm4qkugf5urltct3sjqa"
